...
def archive_coverage(gdf,start_date,end_date,api_key,low_res,cloud,data_type,coverage_resolution,percent_coverage,filepath, min_ona, max_ona, alpha=12,source=['all'],clean=True):
    searchlist=[]
    faillist=[]
    productidlist=[]
